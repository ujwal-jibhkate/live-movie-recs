...
/**
 * Projects a 512-d embedding into the same fixed 2D space as the precomputed
 ...
 */
export function projectToPca(embedding: Float32Array, pca: PcaTransform): [number, number] {
